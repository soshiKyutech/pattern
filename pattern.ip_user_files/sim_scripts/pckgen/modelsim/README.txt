...
#
# Generated by export_simulation on Thu Jan 12 23:06:12 JST 2023
#
################################################################################
...
'-reset_run' switch to the './pckgen.sh' script.
...
./pckgen.sh -noclean_files

For more information on the script, please type './pckgen.sh -help'.
